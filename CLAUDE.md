...
### 個人分頁：個人日常紀錄手帳（2026-09-02 上線，尚未 commit）
...
閱讀學習、體重紀錄、每日復盤、雷達總覽。**這次只做前三個**（首頁總覽／今日任務／習慣打卡），
其餘 5 個先留「還在規劃中」的空框架，等她指示要做哪個再動工。
...
- 六維雷達：事業/家庭/學習/健康/自己看任務完成率或連續天數，快樂維度固定 0%（等每日復盤做出
  心情紀錄才接得上）
- **收支記帳／每日復盤是獨立一份資料，刻意不接她既有的記帳 App 或 `/journal` skill**（她自己選的）
